...
(function() {
  ...
  window.liftAjax = {
    ...
    lift_registerGC: function() {
      ...
      jQuery.ajax({ url : liftAjax.addPageName("/ajax_request/"), data : data, type : "POST", dataType : "script", timeout : 5000, cache : false, success : liftAjax.lift_successRegisterGC, error : liftAjax.lift_failRegisterGC });
       },
    ...
    lift_actualAjaxCall: function(data, onSuccess, onFailure) {
      jQuery.ajax({ url : liftAjax.addPageName("/ajax_request/"), data : data, type : "POST", dataType : "script", timeout : 5000, cache : false, success : onSuccess, error : onFailure });
        },

        lift_actualJSONCall: function(data, onSuccess, onFailure) {
          jQuery.ajax({ url : liftAjax.addPageName("/ajax_request/"), data : data, type : "POST", dataType : "json", timeout : 5000, cache : false, success : onSuccess, error : onFailure });
              }
            };
