(function () {
    ...
    var name = EG.GameObjectNames.WarningAnimation;
    var type = EG.GameObjectTypes.DECAYING;
    var info = {
        brokenImage: 'images/warningbuilding.png' // when it's dead
    };
    ...
    var fn = function(x, y) {
        ...
        var img = EG.textureLibrary.get('images/warningbuilding.png');
